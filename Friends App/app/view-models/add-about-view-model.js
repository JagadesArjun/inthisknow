    ...
    AddActivityViewModel.prototype.addActivity = function () {
        ...
        return new Promise(function (resolve, reject) {
            if(validationModule.validate(that._activity, [validationModule.minLengthConstraint],"Invalid activity")){
                ...
                var makeupdate = AppSettings.getString(USER_ID_ID);
                data.updateSingle({ Id: makeupdate, 'about': that.activity },
                    function(data){
                        var name = AppSettings.getString(USER_ID_NAME);
                        var notification = {"Android":{"data":{"title":"Friends","message": name+" has updated his status","customData": "ZZ789Y"}}};
